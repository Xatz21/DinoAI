...
RUN = [pygame.image.load(os.path.join("imgs/dino", "DinoRun1.png")),
           pygame.image.load(os.path.join("imgs/dino", "DinoRun2.png"))]

JUMP = pygame.image.load(os.path.join("imgs/dino", "DinoJump.png"))

BG = pygame.image.load(os.path.join("imgs/bg", "Track.png"))
...
class Obstacle:
    def __init__(self, image, num_of_cact):
        self.image = image
        self.type = num_of_cact
...
class SmallCactus(Obstacle):
    def __init__(self, image, num_of_cact):
        super().__init__(image, num_of_cact)
        self.rect.y = 325
